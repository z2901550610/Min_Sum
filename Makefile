...
test-trike-encaps-core-reference: $(TRIKE_ENCAPS_REFERENCE_FIXTURE)
	...
	@$(SIM) ./obj_dir/Vtb_trike_encaps_core_reference +verilator+quiet
	@$(VERILATOR) $(VERILATOR_FLAGS) -GUSE_SHARED_SM3=1 -GUSE_SHARED_MUL=1 -GUSE_SHARED_H123=1 -GUSE_SHARED_SAMPLER=1 -GUSE_SHARED_H4_STORE=1 --top-module tb_trike_encaps_core_reference $(TRIKE_ENCAPS_RTL) tb/tb_trike_encaps_core_reference.sv
	@$(SIM) ./obj_dir/Vtb_trike_encaps_core_reference +verilator+quiet
