...
test-unit:
	...
	@$(VERILATOR) $(VERILATOR_FLAGS) --top-module tb_ram_m rtl/bike_pkg.sv rtl/ram_m_bram.sv rtl/ram_m.sv tb/tb_ram_m.sv
	@$(SIM) ./obj_dir/Vtb_ram_m +verilator+quiet
	@$(VERILATOR) $(VERILATOR_FLAGS) -DBIKE_K_SIGN_K=2 --top-module tb_k_sign_update rtl/bike_pkg.sv rtl/k_sign_update.sv rtl/k_sign_reconstruct.sv rtl/ram_k_tile.sv rtl/k_sign_selector.sv rtl/ram_k_global.sv tb/tb_k_sign_update.sv
