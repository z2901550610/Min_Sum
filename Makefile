...
.PHONY: all golden sim test test-unit test-integration golden-self-test golden-paper80-once golden-paper80-batch bike-golden-self-test bike-golden-once bike-golden-batch bike-golden-calibrate
...
$(BIKE_GOLDEN_BIN): golden/bike_l1_min_sum_golden.c
	$(CC) $(CFLAGS) -o $@ $<
