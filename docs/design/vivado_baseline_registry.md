...
| KeyGen | TRIKE-2窄I/O，当前共享乘法调度 | 当前routed基线 | [RUN-20260811-02](../../reports/vivado/manifests/RUN-20260811-02-trike-keygen.toml) | 46,464 LUT，22 BRAM Tile，WNS +0.025 ns |
| 固定profile Decaps最大物理包络 | `trike_decaps_synth_top`，统一最大几何，L=32，K=4，C=256 | 当前routed基线 | [RUN-20260811-01](../../reports/vivado/manifests/RUN-20260811-01-trike-decaps.toml) | 63,386 LUT，635 BRAM Tile，WNS +0.033 ns |
| 运行时统一Decaps | `trike_decaps_runtime_synth_top`，四档，L=32，K=4，C=256 | 待实现 | 无 | 资源、布局布线与时序均待测 |
