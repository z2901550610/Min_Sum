...
(
  input  logic [I_ENTRY_W-1:0] i_ram_i_entry [0:L-1], // entry 中保存的是{one_idx, row_idx_group}
  ...
  always_comb begin
    for (int group_idx = 0; group_idx < L; group_idx++) begin
      ...
      logic [ONE_IDX_W-1:0]             one_idx; // 全局“1”的idx
      ...
      one_idx = i_ram_i_entry[group_idx][I_ENTRY_ONE_IDX_LSB +: ONE_IDX_W];
      ...
      o_ram_i_entry[group_idx] = {one_idx, next_row_idx_group};
    end
  end
endmodule
