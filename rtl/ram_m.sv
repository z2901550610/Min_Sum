...
(
  ...
  input  logic i_rst_n,
  input  logic i_we,
  input  logic [ROW_IDX_W-1:0] i_read_row_idx_group,      // Check-row state read address.
  input  logic [ROW_IDX_W-1:0] i_write_row_idx_group,     // Check-row state write address.
