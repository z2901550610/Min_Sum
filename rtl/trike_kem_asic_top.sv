...
// modes share one SM3 compression service; inactive modes receive no start or
// input traffic. KeyGen/Encaps use the official TRIKE-2 geometry while Decaps
// retains the validated runtime K-sign profile table.
