...
def emit_pkg(path: Path, cases: list[dict[str, object]]) -> None:
    lines = [
        ...
        "  localparam logic [DEC_STATE_W-1:0] DEC_CNU_A            = DEC_INIT_CNU_A;",
        "  localparam logic [DEC_STATE_W-1:0] DEC_CNU_B            = DEC_PIPE_PREP;",
        "  localparam logic [DEC_STATE_W-1:0] DEC_VNU_ACCUM        = DEC_PIPE_PREP;",
        "  localparam logic [DEC_STATE_W-1:0] DEC_VNU_EMIT         = DEC_PIPE_DRAIN;",
